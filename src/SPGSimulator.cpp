...
void SPGSimulator::step() {
    ...
    visualizer.render(robot, obstacles, ball, robot_traj, robot_traj_400ms, obs_traj, state_.target.p, state_.subtarget.p, simulation_time_, step_count_, simulation_completed_);
}